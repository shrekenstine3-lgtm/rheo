  ...
  return (
    <main className="min-h-screen bg-slate-50 text-slate-900">
      ...
      <section className="mx-auto max-w-5xl px-6 py-10">
        ...
        <div className="mt-8 grid gap-6 md:grid-cols-2">
          <div className="rounded-3xl bg-white p-6 shadow-sm ring-1 ring-slate-200">
            <h3 className="text-xl font-semibold text-slate-950">Aggregated data use</h3>
            <p className="mt-4 text-sm leading-6 text-slate-600">
              Rheo may use anonymized and aggregated usage patterns to understand approval timing,
              household balance usage, service mix, and access friction points. The purpose of this
              data use is to improve pilot design, payout logic, access flow, and partnership value.
            </p>
          </div>

          <div className="rounded-3xl bg-white p-6 shadow-sm ring-1 ring-slate-200">
            <h3 className="text-xl font-semibold text-slate-950">Household protections</h3>
            <p className="mt-4 text-sm leading-6 text-slate-600">
              RheoPassport is designed around capped support, shared household visibility, and a
              controlled approval model. Primary accounts manage the household structure, while
              dependents use the shared balance under program rules.
            </p>
          </div>
        </div>

        <div className="mt-8 rounded-3xl bg-white p-8 shadow-sm ring-1 ring-slate-200">
          <h2 className="text-2xl font-semibold text-slate-950">Important program statements</h2>
          <div className="mt-6 space-y-4 text-sm leading-6 text-slate-600">
            <p>
              <span className="font-medium text-slate-900">Rheo is not insurance.</span> It is a
              support layer model designed to reduce small co-pay barriers.
            </p>
            <p>
              <span className="font-medium text-slate-900">Rheo is not medical advice.</span> Medical
              decisions remain between users and qualified healthcare professionals.
            </p>
            <p>
              <span className="font-medium text-slate-900">Support is controlled and capped.</span>
              Approvals are subject to program rules, pilot limits, and household balance availability.
            </p>
            <p>
              <span className="font-medium text-slate-900">Ledger transparency is limited to accounting and compliance uses.</span>
              Sensitive health details should remain outside public verification layers.
            </p>
          </div>
        </div>
      </section>
